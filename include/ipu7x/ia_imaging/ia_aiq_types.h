...
{
    scd_tnr_6_0,        /*!< TNR_6_0. */
    scd_cca_smart_skip, /*!< CCA POWER CONTROL. */
...
typedef struct
{
    ...
    bool cca_skipped_on_curr_frame;             /*!<indicator whether the 3A calculation was skipped in the current frame  */
} ia_aiq_scd_results;
...
typedef struct
{
    ia_aiq_frame_params *sensor_frame_params;        /*!< Mandatory for IPU6. Sensor frame parameters. Describe frame scaling/cropping done in sensor.
                                                          Deprecated for IPU7. replaced by statistics_crop CCAT field that includes both cropping in the sensor and pipe*/
...
/** @brief NNTM parameters.
 * This structure is used for NNTM (Neural Network Tone Mapping) configuration parameters.
 */

typedef struct {
    bool enable;                 /**< Is enabled flag */
