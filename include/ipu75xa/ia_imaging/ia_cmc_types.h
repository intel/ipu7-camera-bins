...
typedef struct
{
    ...
    int32_t ldc_grid_size;                             /*!< Grid size for ldc  (32,64,128) */
    uint8_t interpolation_type;                        /*!< Interpolation Type for gdc  (0=BiLinear, 1=BiCubic) */
    int32_t image_window_vertical_shift;               /*!< Vertical Shift for window */
    int32_t image_window_horizontal_shift;             /*!< Horizontal Shift for window */
    uint8_t use_ineffective_values;                    /*!< Use Ineffective Values for gdc (0=Regular, 1=Ineffective) */
...
typedef struct
{
    ia_mkn_record_header header; /*!< Record header with Format ID: cmc_media_format, Name ID: cmc_name_id_media_format (See cmc_name_id). */
    int32_t format;              /*!< media format for video/preview/still. */
...
typedef struct
{
    ...
    cmc_media_format_info_t *cmc_parsed_media_format_stills;
