...
#ifdef __cplusplus
#define CAST_TYPE(type, value) (static_cast<type>(value))
#else
#define CAST_TYPE(type, value) ((type)(value))
#endif
...
#define IA_MKN_CHTOUL(a,b,c,d) \
    ( CAST_TYPE(uint32_t, a) | (CAST_TYPE(uint32_t, b)<<8) | (CAST_TYPE(uint32_t, c)<<16) | (CAST_TYPE(uint32_t, d)<<24) )
 ...
 */
#define IA_MKN_ENUMS_DATA_REVISION 0x14012702U
